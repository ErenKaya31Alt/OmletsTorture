...
class MainMenuState extends MusicBeatState
{
	...
	public static var omletsTortureVersion:String = '0.1 BETA';//This is also used for Discord RPC
	...
	override function create()
	{
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "Omlets Torture v" + omletsTortureVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
