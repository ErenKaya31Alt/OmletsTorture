...
class FreeplayState extends MusicBeatState
{
	...
	private var AllPossibleSongs:Array<String> = ["main", "joke", "youre fucked", "extra"];
	...
	override function create()
	{
		...
		CurrentSongIcon = new FlxSprite(0,0).loadGraphic(Paths.image('week_' + (AllPossibleSongs[CurrentPack].toLowerCase())));
	...
	public function LoadProperPack()
		{
			...
			{
				case 'main':
					addWeek(['Coolness'], 2, ['Kdj']);
					addWeek(['Freaky'], 2, ['Bobbby']);
					addWeek(['Moon-Light'], 2, ['Alex']);
					addWeek(['Peace'], 2, ['Mati']);
				case 'joke':
	...
	override function update(elapsed:Float)
	{
		...
		if (fuckyou)
		{
			...
			FlxG.save.data.demolitionFound = true;
